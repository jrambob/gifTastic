var ancientHero = ["Julius Caesar", "Alexander the Great", "Achilles", "Hannibal Barca"];

$(document).ready(function() {
    for (var i = 0; i < ancientHero.length; i++) {
        $("#hero-buttons").append("<button type='button' onclick='searchGif(\"" + ancientHero[i] + "\")' class='btn btn-primary' value=' " + ancientHero[i] + "'> " + ancientHero[i] + " </button>");
    }
});
